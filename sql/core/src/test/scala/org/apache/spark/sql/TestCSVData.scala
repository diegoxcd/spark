...
object TestCSVData {
  ...
  val amazon2 =  TestSQLContext.applySchema(amazonRdd,schemaAmazon)
  ...
  val reviews =  TestSQLContext.applySchema(reviewsRdd,schemaReviews)
  ...
  val openReviews =  TestSQLContext.applySchema(openReviewsRdd,openSchemaReviews)
  ...
  val openReviews2 =  TestSQLContext.applySchema(openReviewsRdd2,openSchemaReviews2)
